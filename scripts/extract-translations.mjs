...
const protectedCopy = [
  ...
  "Orchids The International School", "Hatiara Girls' High Madrasah", "De Sovrani",
  ...
  "Rajiv Gandhi Institute of Technology", "BNM Institute of Technology", "PES University",
